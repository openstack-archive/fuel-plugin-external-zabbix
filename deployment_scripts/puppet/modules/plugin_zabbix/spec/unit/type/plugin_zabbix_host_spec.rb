...
#
require 'puppet'
require 'puppet/type/plugin_zabbix_host'


describe 'Puppet::Type.type(:plugin_zabbix_host)' do

  before :each do
    @zabbix_host = Puppet::Type.type(:plugin_zabbix_host).new(:name => 'testhost', :host => 'testhost', :groups => ['testgroup'])
  end
