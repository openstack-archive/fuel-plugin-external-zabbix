...
html_context = {
    'css_files': [
        '_static/default.css',  # overrides CSS defs
        ],
    }
...
latex_documents = [
    (master_doc, 'TheZabbixpluginforFuelTestPlan.tex', u'The Zabbix plugin for Fuel Test Plan Documentation',
     u'Mirantis', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'TheZabbixpluginforFuelTestPlan', u'The Zabbix plugin for Fuel Test Plan Documentation',
     author, 'TheZabbixpluginforFuelTestPlan', 'One line description of project.',
     'Miscellaneous'),
]
